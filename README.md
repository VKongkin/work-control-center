...
- 🧰 **Tools from a link**: The Tools page builds a small web app out of a GitHub or GitLab link — including your own GitLab behind the firewall — instead of uploading the folder by hand. Off until you list the hosts WCC may fetch from, because this is the one place the *server* fetches a URL somebody typed
